...
async def main():
    ...
    try:
        ...
        logger.info(f"   Resources: W:{castle.resources.wood:,} S:{castle.resources.stone:,} F:{castle.resources.food:,}")
